...
<body class="js">
    ...
    <div class="seciton v2contact-page section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="about-form contact-formv2">
                        ...
                        <div class="v2-about-textarea">
                            <textarea name="message" id="messages" cols="30" rows="10" placeholder="Write your comment here..."></textarea>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 margin-top-resposnive">
                    ...
                    <div class="row mt30 single-contact">
                        ...
                        <div class="col-xs-10">
                            <h4>1 Dundas St. West Toronto, Ontario Canada L4B BJ9, <br>1209</h4>
                        </div>
                    </div>
