...
<!-- Mirrored from www.kazierfan.com/themes/medicre/medicre/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Oct 2023 02:17:12 GMT -->
...
<body class="js">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="topbar-single-div">
                        ...
                        <h4>Call us: 1.777.777.777</h4>
                    </div>
                    <div class="topbar-single-div">
                        <i class="fa fa-envelope"></i>
                        <h4>hello@theerfan.com</h4>
                    </div>
                </div>
    ...
    <div class="version-3-logo">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <a class="site-logo" href="#"><img src="img/logo.png" alt="jigsawlab"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-area">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav top-search navbar-right navbar-nav">
                        <li>
                                ...
                                <div class="col-sm-6 slider-content-area text-left">
                                    <div class="v3 welcome-text">
                                        ...
                                        <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            The industry's standard dummy text ever The industry's standard dummy text
                                            ever since the 1500, lorem Ipsum is simply dummy text lorem Ipsum is simply
                                            dummy text.</h4>
                                        <a href="#" class="read-more">READ MORE</a>
                                    </div>
                                </div>
                                <div class="col-sm-6 v3-homeform">
                                    <div class="about-form">
                                        ...
                                        <div class="v2-about-input mr0">
                                            <div class="v2-about-select">
                                                <select>
                                                    <option value="Preferred Date & Time">Preferred Date & Time
                                                    </option>
                                                    <option value="Preferred Date & Time">Preferred Date & Time
                                                    </option>
                                                    <option value="Preferred Date & Time">Preferred Date & Time
                                        ...
                                        <div class="v2-about-textarea">
                                            <textarea name="message" id="message2" cols="30" rows="10" placeholder="Write your comment here..."></textarea>
                                        </div>
    ...
    <!-- start features area -->
    <section class="features-area v3 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 text-center">
                    <div class="single-features v3">
                ...
                <div class="col-sm-4 text-center">
                    <div class="single-features v3 active">
                        <div class="features-icon">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="aboutUs-contant">
                        ...
                        <a href="services-3.html" class="about-btn">VIEW SERVICES</a>
                    </div>
                </div>
                <div class="col-sm-6">
    ...
    <section class="department-section v2 v3 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
                        <h1><span>Our</span> Departments</h1>
                        <p>Maecenas scelerisque felis ornare placer tempus. In turpis nisi, viverra hendrerit dolo.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <ul class="nav nav-justified nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#surgery" aria-controls="surgery" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/nav-icon-1.png" alt="jigsawlab"></div>
                                        <h4>SURGERY</h4>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="surgery">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="tab-title">
                                                <h2>DETAILS OF <span>CANCER</span></h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 department-content">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce suscipit
                                                augue ornare atis elementum. Fusce elit justo, molestie tincidunt
                                                tincidunt ut, imperdiet nec lorem. Inteer suscipit varius pharetra. In
                                                vulputate tristique lectus, nec pellentesque leo ornare luctus. Cras
                                                ullamcorper ipsum ac imperdiet cursus. Aliquam posuere in odio vel
                                                sodales.
                                            </p>
                                            <p>Suspendisse congue magna non neque congue dapibus. Fusce gravida, ipsum
                                                in bulum adipiscing, odio ligula pretium est, sed porttitor urna quam
                                                sit amet arcu. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            </p>
                                        </div>
                                        <div class="col-sm-4 department-content">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce suscipit
                                                augue ornare atis elementum. Cras ullamcorper ipsum ac imperdiet cursus.
                                                Aliquam posuere in odio vel sodales. </p>
                                            <p>
                                                Suspendisse congue magna non neque congue dapibus. Fusce gravida, ipsum
                                                in bulum adipiscing, odio ligula pretium est, sed porttitor urna quam
                                                sit amet arcu, ipsum in bulum adipiscing</p>
                                            <a href="#" class="service-link">READ MORE +</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 department-content">
                                            ...
                                            <p>Nunc et risus in massa mattis lacinia. Pellentesque ornare mi sit amet
                                                purus malesuada blandit. Nunc et risus in massa mattis lacinia.
                                                Pellentesque ornare mi sit amet purus malesuada blandit. Quisque
                                                scelerisque a lectus vel ornare. Etiam pellentesque justo ipsum, et
                                                pretium felis vulputate ac...</p>
                                            <a href="#" class="read-more">Read More</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="speacialist-area v3 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="view-alldoctors">
                        <a href="medical-stuff-3.html" class="read-more">view all doctors</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
                        ...
                        <p>Maecenas scelerisque felis ornare placer tempusn.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <div class="single-client wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                        <div class="client-content">
                            ...
                            <p>As soon as you can, use real and relevant words. If your site or application requires
                                data input, enter the real deal. And actually type in the text. If your site or
                                application requires data input, enter the real deal.</p>
                        </div>
                        <div class="client">
            ...
            <div class="row">
                    ...
                    <a href="single.html">
                        <div class="single-news-v3">
                            <div class="news-thumb">
                                <img src="img/news-1.png" alt="jigsawlab">
                            </div>
                            <h4 class="news-title text-uppercase">George QUICK</h4>
                            <h4>27th Feb, 2016</h4>
                            <p>Our construction management professio nals organize, lead, and manage the people,
                                materials, and processes of construction utilizing the latest techno logies.</p>
                        </div>
                    </a>
                </div>
                <div class="col-sm-4">
                    <a href="single.html">
                        <div class="single-news-v3">
                            <div class="news-thumb">
                                <img src="img/news-2.png" alt="jigsawlab">
                            </div>
                ...
                <div class="col-sm-4">
                    <a href="single.html">
                        <div class="single-news-v3">
                            <div class="news-thumb">
                                <img src="img/news-3.png" alt="jigsawlab">
                            </div>
...
<!-- Mirrored from www.kazierfan.com/themes/medicre/medicre/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Oct 2023 02:17:14 GMT -->
