...
<body class="js">
    ...
    <section class="department-section v2 section-padding">
        <div class="container">
            <div class="row">
                            ...
                            <ul class="nav nav-justified nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#surgery" aria-controls="surgery" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/nav-icon-1.png" alt="theimran.com"></div>
                                        <h4>SURGERY</h4>
                                    </a>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="department-img">
                                                <img src="img/v2tab.png" alt="theimran.com">
                                            </div>
                                        </div>
    ...
    <section class="mediacare-client-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="details-navv2">
                        <div class="col-sm-2">
                            <div class="single-img">
                                <img src="img/testimonial-1.png" alt="themediacare.com">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="single-img">
                                <img src="img/testimonial-2.png" alt="themediacare.com">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="single-img">
                                <img src="img/testimonial-3.png" alt="themediacare.com">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="single-img">
                                <img src="img/testimonial-4.png" alt="themediacare.com">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="single-img">
                                <img src="img/testimonial-6.png" alt="themediacare.com">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="single-img">
    ...
    <!-- start specialist area -->
    <section class="speacialist-area v2 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="view-alldoctors">
                        <a href="medical-stuff-2.html" class="read-more">view all doctors</a>
                    </div>
                </div>
            </div>
        </div>
