...
<!-- Mirrored from www.kazierfan.com/themes/medicre/medicre/medical-stuff-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Oct 2023 02:17:18 GMT -->
...
<body class="js">
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb">
                                    <li><a href="#">Home</a></li>
                                    <li class="active"><a href="#">Medical Stuffs</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <section class="department-section singlepage section-padding">
        <div class="container">
            <div class="row">
                            ...
                            <ul class="nav nav-justified nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#surgery" aria-controls="surgery" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/md-stuff-1.png" alt="jigsawlab"></div>
                                        <h4>SURGERY</h4>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#dentalcare" aria-controls="dentalcare" role="tab"
                                        data-toggle="tab">
                                        <div class="navimg">
                                            <img src="img/md-stuff-2.png" alt="jigsawlab">
                                        </div>
                                        <h4>DENTAL CARE</h4>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#diseases" aria-controls="diseases" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/md-stuff-3.png" alt="jigsawlab"></div>
                                        <h4>ALLERGIC DISEASES</h4>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#eaycare" aria-controls="eaycare" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/md-stuff-4.png" alt="jigsawlab"></div>
                                        <h4>EYE CARE</h4>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#cancer" aria-controls="cancer" role="tab" data-toggle="tab">
                                        <div class="navimg"><img src="img/md-stuff-5.png" alt="jigsawlab"></div>
                                        <h4>CANCER</h4>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#nurology" aria-controls="nurology" role="tab" data-toggle="tab">
                                        <div class="navimg">
                                            <img src="img/md-stuff-6.png" alt="jigsawlab">
                                        </div>
                                        <h4>nurology</h4>
                                    </a>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <div class="view-alldoctors">
                                                <a href="#" class="read-more">view all doctors</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from www.kazierfan.com/themes/medicre/medicre/medical-stuff-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Oct 2023 02:17:21 GMT -->
